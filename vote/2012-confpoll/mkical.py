...
YEAR = 2012
CANDIDATES_OPENED_DATE    = (2011, 10, 19)
CANDIDATES_CLOSED_DATE    = (YEAR,  1, 22)
CANDIDATES_ANNOUNCED_DATE = (YEAR,  1, 28)
VOTING_OPENED_DATE        = (YEAR,  2, 12)
VOTING_CLOSED_DATE        = (YEAR,  2, 19)
PRELIMINARY_RESULTS_DATE  = (YEAR,  2, 20)
CHALLENGE_CLOSED_DATE     = (YEAR,  2, 26)
...
CANDIDATES_OPENED = (
    ...
    info@documentfoundation.org with your name, e-mail 

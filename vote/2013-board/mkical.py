...
YEAR = 2013
CANDIDATES_OPENED_DATE    = (YEAR, 10, 23)
CANDIDATES_CLOSED_DATE    = (YEAR, 12,  2)
CANDIDATES_ANNOUNCED_DATE = (YEAR, 12,  6)
VOTING_OPENED_DATE        = (YEAR, 12, 10)
VOTING_CLOSED_DATE        = (YEAR, 12, 17)
PRELIMINARY_RESULTS_DATE  = (YEAR, 12, 18)
CHALLENGE_CLOSED_DATE     = (YEAR, 12, 23)

...
YEAR = 2011
CANDIDATES_OPENED_DATE    = (YEAR, 9,   2) # In 2012, begin earlier in May
CANDIDATES_CLOSED_DATE    = (YEAR, 10,  1)
CANDIDATES_ANNOUNCED_DATE = (YEAR, 10,  3)
VOTING_OPENED_DATE        = (YEAR, 10,  7)
VOTING_CLOSED_DATE        = (YEAR, 10, 17)
PRELIMINARY_RESULTS_DATE  = (YEAR, 10, 20)
CHALLENGE_CLOSED_DATE     = (YEAR, 10, 26)
